...
global $UMC_ENV, $ITEM_SEARCH, $UMC_DATA_ENCHANTMENTS, $UMC_DOMAIN, $UMC_PATH_MC, $UMC_FUNCTIONS, $UMC_PATTERNS, $UMC_COLORS_DEC;
global $ITEM_SPRITES, $BROKEN_ITEMS, $ITEM_UNAVAILABLE;
...
require_once($UMC_PATH_MC . '/server/bin/assets/item_enchantments.inc.php');
...
require_once($UMC_PATH_MC . '/server/bin/assets/item_unavailable.inc.php');
...
require_once($UMC_PATH_MC . '/server/bin/includes/wiki_data.inc.php');
